...
let images = ["./images/img-3.jpg", "./images/img-4.jpg", "./images/img-2.jpg"];

//, "./images/img-4.jpg", "./images/img-2.jpg"
let current = 0;
let playing = false;
...
const menu = document.querySelector(".nav-logo");

menu.addEventListener("click", () => {
  menu.classList.toggle("active");
  if (menu.classList.contains("active")) {
    menu.src = "./images/icons/close.svg";
